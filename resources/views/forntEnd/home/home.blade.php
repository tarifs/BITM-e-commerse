            ...
            <div class="agileinfo-ads-display col-md-9">
                <div class="wrapper">
                    ...
                    <div class="product-sec1">
                        <h3 class="heading-tittle">New Products</h3>
                        @foreach($productViews as $productView)
                        <div class="col-md-4 product-men">
                            <div class="men-pro-item simpleCart_shelfItem">
                                <div class="men-thumb-item">
                                    <img src="{{asset($productView->product_image)}}" alt="">
                                ...
                                <div class="item-info-product ">
                                    <h4>
                                        <a href="single.html">{{$productView->product_name}}</a>
                                    </h4>
                                    <div class="info-product-price">
                                        <span class="item_price">TK. {{$productView->product_name}}</span>
                                        <del>$280.00</del>
                                    </div>
